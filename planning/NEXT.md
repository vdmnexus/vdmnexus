# Tomorrow's plan — 2026-07-14

Rolling pointer, overwritten in full by each daily run of
`prompts/00-daily-review.md`. Full context: `planning/daily/2026-07-13.md`.

1. **Decision needed on roadmap item 7** — fourteen days stale in this
...
5. No new outreach/distribution branches until the backlog clears —
   eight quiet days running is worth noticing, not just repeating.
