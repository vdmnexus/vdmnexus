...
1. **Process integrity — two open decisions, repeated plainly.**
   ...
   Re-verified tonight (2026-08-24) against #175/#176/#177/#178/#179
   individually — all five still fail the same check, unchanged.
   ...
   in `#nexus` since 2026-08-09 (15+ days). Neither ask has had a
   ...
   #179 → tonight's) rather than starting fresh.
...
3. **Launch readiness** (`marketing/token-launch-checklist.md`): the
   ...
   twenty-eighth night running as the top actionable item with no PR
...
4. **Rienda M1-M5**: last reported status (2026-07-31, from Dennis) —
   ...
   started. Now 24 days stale as of 2026-08-24 — continue asking
   Dennis directly for a fresh update. Carry forward unchanged until
   one lands.
5. **Health checks — still an infra blocker, at least 26 consecutive
...
6. **Standing blocked items**: #106 (cards-v1 spec) — still a merge-
   or-close decision, open since 2026-05-24 (92+ days). #95
   (Polymarket agent) — still blocked on Spanish counsel, 93+ days.
   Legal memo — still status-tracking: email drafted, awaiting Dennis
   send. May manual-submission backlog — one line, no more.

## Process watch

Tonight (2026-08-24) re-verified #175–#179 are all still CI-red on
the same diagnosed Vercel Hobby-plan cron-limit issue, unchanged
since 2026-08-18T20:13Z. Not merging any of them or tonight's PR. The
planning-PR backlog is now six deep. Keep re-verifying (not just
carrying forward) each night, and merge the backlog in order the
moment the Vercel check clears. The deposit-crediting RPC-429 finding
(2026-08-21) has now sat unaddressed for 3+ days with real financial
stakes — worth flagging with more weight than a routine repeat.
