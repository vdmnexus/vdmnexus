...
`prompts/00-daily-review.md`. Full context: `planning/daily/2026-07-22.md`.

1. **Decision needed on roadmap item 7** — twenty-three days stale in
...
5. No new outreach/distribution branches until the backlog clears —
   seventeen quiet days running is worth noticing, not just repeating.
