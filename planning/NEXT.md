# Tomorrow's plan — 2026-07-22

Rolling pointer, overwritten in full by each daily run of
`prompts/00-daily-review.md`. Full context: `planning/daily/2026-07-21.md`.

1. **Decision needed on roadmap item 7** — twenty-two days stale in
...
5. No new outreach/distribution branches until the backlog clears —
   sixteen quiet days running is worth noticing, not just repeating.
