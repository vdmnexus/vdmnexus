...
// Vercel Cron relay for the resolution watcher. Pings the Python
// agent's /resolve endpoint, which polls Polymarket for resolved
// open bets and updates Supabase with the outcome + PnL.
...
async function handle(req: Request) {
  ...
  const target = new URL("/resolve", agentUrl).toString();
  try {
