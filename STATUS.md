...
| `claude/marketing-video-pipeline` | VHS terminal-demo pipeline + Remotion ship-reels scaffold + `/ship-broadcast` visual companion step | 2026-05-22 | in_review | _PR pending_ |
