...
| `claude/site-audit-nav-fixes` | Post-#149 site audit: route inventory, dead-link fixes, nav/footer IA for the two-layer story, playground upstream_error root cause (SDK empty-body handling + nexus rate-limit fail-open), VOICE.md + copy-lint in CI | 2026-07-31 | in_review | [#150](https://github.com/vdmnexus/vdmnexus/pull/150) |
